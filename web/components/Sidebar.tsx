...
export default function Sidebar() {
  ...
  return (
    <div
      className="relative flex-shrink-0 h-full border-r border-slate-200/60 dark:border-slate-800/60 bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl flex flex-col transition-all duration-300 ease-in-out overflow-hidden"
    ...
    >
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded transition-colors"
                  ...
                  >
                    <Link
                      ...
                      className={`flex items-center rounded-md border transition-all duration-200 ${
                        ...
                        isActive
                          ? "bg-white dark:bg-slate-800 text-emerald-700 dark:text-emerald-300 shadow-sm border-slate-100 dark:border-slate-700"
                          : "text-slate-600 dark:text-slate-300 hover:bg-white/70 dark:hover:bg-slate-800/60 hover:text-emerald-700 dark:hover:text-emerald-300 hover:shadow-sm border-transparent hover:border-slate-100 dark:hover:border-slate-700"
                      }`}
                      onMouseEnter={() =>
      ...
      {/* Footer */}
      <div
        className={`border-t border-slate-200/60 dark:border-slate-800/60 bg-white/40 dark:bg-slate-950/30 transition-all duration-300 ${
      ...
      >
        <div className="relative">
          <Link
            ...
            className={`flex items-center rounded-md text-sm transition-all duration-200 ${
              ...
              pathname === "/settings"
                ? "bg-white dark:bg-slate-800 text-emerald-700 dark:text-emerald-300 shadow-sm border border-slate-100 dark:border-slate-700"
        ...
        <button
          onClick={toggleSidebar}
          className={`w-full mt-2 flex items-center rounded-md text-slate-400 dark:text-slate-500 hover:bg-white dark:hover:bg-slate-800 hover:text-emerald-600 dark:hover:text-emerald-400 hover:shadow-sm border border-transparent hover:border-slate-100 dark:hover:border-slate-700 transition-all duration-200 ${
