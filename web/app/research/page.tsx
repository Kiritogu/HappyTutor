  ...
  return (
    <div className="h-screen animate-fade-in flex gap-4 p-4">
      ...
      <div className="flex-[1_1_33%] min-w-[350px] max-w-[500px] flex flex-col gap-4 h-full">
        {/* Config Header */}
        <div className="dt-panel p-4 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="flex items-center justify-between bg-slate-50 dark:bg-slate-700 px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600">
              <div className="flex items-center gap-2">
                <Sparkles
                  className={`w-4 h-4 ${enableOptimization ? "text-emerald-600 dark:text-emerald-400" : "text-slate-400 dark:text-slate-500"}`}
                />
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full relative transition-colors ${enableOptimization ? "bg-emerald-500" : "bg-slate-300 dark:bg-slate-600"}`}
              >
                <div
        ...
        {/* Chat Interface */}
        <div className="dt-panel flex-1 flex flex-col overflow-hidden">
              ...
              >
                <div
                  className={`max-w-[90%] rounded-2xl px-4 py-3 text-sm ${
                    msg.role === "user"
                      ? "bg-emerald-50 dark:bg-emerald-900/35 text-emerald-950 dark:text-emerald-50 rounded-tr-none border border-emerald-100/60 dark:border-emerald-900/40"
                      : "bg-white/80 dark:bg-slate-900/60 border border-slate-200/60 dark:border-slate-700/60 text-slate-700 dark:text-slate-200 rounded-tl-none shadow-sm"
                  }`}
                >
                  {msg.isOptimizing ? (
                    <div className="flex items-center gap-2">
          ...
          <div className="p-3 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700">
            <div className="relative flex items-center gap-2">
              <input
                ...
                className="flex-1 pl-4 pr-10 py-2.5 bg-white/70 dark:bg-slate-900/40 border border-slate-200/70 dark:border-slate-700/60 focus:border-emerald-500/70 focus:ring-2 focus:ring-emerald-500/20 rounded-xl text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 transition-all outline-none disabled:opacity-50"
              />
              <button
                ...
                className="p-2.5 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 disabled:opacity-50 shadow-sm shadow-emerald-500/20"
              >
                {isOptimizing ? (
      ...
      <div className="dt-panel flex-[2_1_67%] min-w-0 flex flex-col h-full overflow-hidden relative">
        <ResearchDashboard
          state={state}
